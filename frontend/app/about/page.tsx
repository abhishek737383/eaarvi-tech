...
export default function AboutPage() {
  ...
  return (
    <main className="min-h-screen bg-gradient-to-b from-white to-zinc-50 dark:from-zinc-900 dark:to-zinc-800 py-12">
      <div className="mx-auto max-w-6xl px-6">
        {/* HERO */}
        <section className="relative overflow-hidden rounded-3xl bg-white/60 dark:bg-zinc-900/50 p-8 md:p-12 shadow-xl backdrop-blur-sm">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            ...
            >
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                ...
                <a
                  href="/services"
                  className="inline-flex items-center gap-2 rounded-full border border-zinc-200 px-4 py-2 font-medium dark:border-zinc-700 hover:bg-zinc-100 dark:hover:bg-zinc-800 transition"
                >
                  Explore Programs
                </a>
              </div>
            ...
            >
              <div className="aspect-[16/10] w-full rounded-xl border border-zinc-100 dark:border-zinc-800 p-4 flex items-center justify-center bg-gradient-to-br from-white to-zinc-50 dark:from-zinc-900/40">
                    ...
                    <div className="p-4 bg-white dark:bg-zinc-900">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <div className="text-xs text-zinc-500">Trainers with real sales experience</div>
                        </div>
                      </div>
        ...
        <section className="mt-8 grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div
            ...
            viewport={{ once: true }}
            className="rounded-xl bg-white/60 dark:bg-zinc-900/50 p-6 shadow"
          >
          ...
          >
            ...
            <ol className="mt-3 list-decimal list-inside text-sm text-zinc-600 dark:text-zinc-300 leading-relaxed">
        ...
        {/* Founder */}
        <section className="mt-10 rounded-2xl bg-gradient-to-br from-white/60 to-zinc-50/60 dark:from-zinc-900/40 dark:to-zinc-800/40 p-6 shadow-md">
          <div className="md:flex md:items-center md:gap-8">
            ...
            <div className="mt-4 md:mt-0">
              ...
              <div className="mt-4 flex gap-3">
                ...
                <a href="/schedule" className="inline-flex items-center gap-2 rounded-full border border-zinc-200 px-4 py-2 font-medium hover:bg-zinc-100 dark:border-zinc-700 transition">
                  Schedule a Discussion
                </a>
              </div>
            </div>
        ...
        <section className="mt-10 grid grid-cols-1 md:grid-cols-3 gap-6">
          <motion.div whileHover={{ scale: 1.03 }} className="rounded-xl bg-white/60 dark:bg-zinc-900/50 p-6 shadow text-center">
            <div className="text-2xl font-extrabold">+20</div>
            <div className="text-sm text-zinc-500">Years of sales experience</div>
          </motion.div>

          <motion.div whileHover={{ scale: 1.03 }} className="rounded-xl bg-white/60 dark:bg-zinc-900/50 p-6 shadow text-center">
            <div className="text-2xl font-extrabold">100+</div>
            <div className="text-sm text-zinc-500">Teams & professionals trained</div>
          </motion.div>

          <motion.div whileHover={{ scale: 1.03 }} className="rounded-xl bg-white/60 dark:bg-zinc-900/50 p-6 shadow text-center">
            <div className="text-2xl font-extrabold">Measurable</div>
            <div className="text-sm text-zinc-500">Outcome-driven results</div>
          </motion.div>
        </section>
